...
//         bytecode_exec.register_function("sin", sin);
//         bytecode_exec.register_function("cos", cos);
//         bytecode_exec.register_function("tan", tan);
//         bytecode_exec.register_function("sqrt", sqrt);
//         bytecode_exec.register_function("log", log);
//         bytecode_exec.register_function("f", f);
//         bytecode_exec.register_function("g", g);
//         bytecode_exec.register_function("h", h);
//         bytecode_exec.bind_variable("a", Value::Number(6.0));
//         bytecode_exec.bind_variable("b", Value::Number(16.0));
//         bytecode_exec.bind_variable("c", Value::Number(12.0));
//         bytecode_exec.bind_variable("d", Value::Number(0.0));
//         bytecode_exec.bind_variable("e", Value::Number(21.0));
//         bytecode_exec.bind_variable("x", Value::Number(7.0));
//         bytecode_exec.bind_variable("y", Value::Number(1.0));
//         bytecode_exec.bind_variable("z", Value::Number(2.0));
//         bytecode_exec.bind_variable(
//             "obj",
//             Value::Map(HashMap::from([
//                 ("prop1".to_string(), Value::Number(12.0)),
//                 ("prop2".to_string(), Value::Number(16.0)),
//                 ("prop3".to_string(), Value::Number(12345.0)),
...
//             "map",
//             Value::Map(HashMap::from([
//                 ("key1".to_string(), Value::Number(21.0)),
//                 ("key2".to_string(), Value::Number(165435.0)),
//             ])),
//         );
//         bytecode_exec.bind_variable("map", Value::Number(2.0));
//
//         // let mut jit_exec = JITExecutor::new();
//         // let mut aot_exec = AOTExecutor::new();
...
//         });
//
//         // group.bench_function(format!("JIT Execution - {label}"), |b| {
//         //     b.iter(|| black_box(jit_exec.execute_jit(&bytecode).unwrap()))
//         // });
//         //
//         // group.bench_function(format!("AOT Execution - {label}"), |b| {
//         //     b.iter(|| black_box(aot_exec.execute_aot(&bytecode).unwrap()))
//         // });
//     }
//
//     group.finish();
